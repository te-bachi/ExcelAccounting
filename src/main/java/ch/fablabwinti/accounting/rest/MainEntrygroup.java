...
public class MainEntrygroup {
    ...
    public void parseInput(File inputFile) throws Exception {
        ...
        for (int skipCount = 0; skipCount < MainEntrygroup.INPUT_ROW_SKIP; skipCount++) {
        ...
        if (isSkipped) {
            while (rowIterator.hasNext()) {
                ...
                /* Date */
                cell = new CustomDateCell(row, MainEntrygroup.INPUT_COLUMN_DATE);
                entrygroup.date = formatter.format(cell.getDate());

                /* Amount */
                cell = new CustomIntCell(row, MainEntrygroup.INPUT_COLUMN_AMOUNT, evaluator);
                ...
                /* Surname */
                cell = new CustomStringCell(row, MainEntrygroup.INPUT_COLUMN_SURNAME);
                entrygroup.title += cell.getString();

                /* Firstname */
                try {
                    cell = new CustomStringCell(row, MainEntrygroup.INPUT_COLUMN_FIRSTNAME);
                    entrygroup.title += " ";
                    entrygroup.title += cell.getString();
    ...
    public static void main(String[] args) throws IOException, URISyntaxException, Exception {
        ...
        MainEntrygroup main = new MainEntrygroup();
