...
public class JournalStyles {
    ...
    public JournalStyles(Workbook workbook) {
        ...
        accountTitleStyle.setBorderBottom(BorderStyle.THIN);
        ...
        accountHeaderStyle.setBorderBottom(BorderStyle.THIN);
        ...
        accountTotalStyle.setBorderBottom(BorderStyle.DOUBLE);
        ...
        balanceStyle.setBorderBottom(BorderStyle.DOUBLE);
